...
def punctuate(
    ...
    """Return a punctuated version of the given function.

    Punctuated functions apply converters to arguments and keyword arguments
    ...
    # Returns
    punctuated (callable):
        A punctuated version of `func` — shares the same signature
        and docstring.
    """
